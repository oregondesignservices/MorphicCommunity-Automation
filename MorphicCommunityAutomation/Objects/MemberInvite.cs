...
/*            IWebElement ADD_MEMBER_BTN = driver.FindElement(By.CssSelector("div:nth-of-type(1) > button:nth-of-type(2)"));
        ...
        public void AddMemberAndSendInvitation()
        {
            ...
            string GET_NAME = driver.FindElement(By.CssSelector("p:nth-of-type(2) > b")).Text;

            Assert.AreEqual(GET_NAME, "Martin Angelove");

            string GET_EMAIL = driver.FindElement(By.CssSelector("p:nth-of-type(3) > b")).Text;
            ...
            IWebElement CANCEL_ADD_MEMBER_BTN = driver.FindElement(By.CssSelector("footer#inviteConfirm___BV_modal_footer_ > .btn.btn-secondary"));
            CANCEL_ADD_MEMBER_BTN.Click();

            wait.Until(d => ((IJavaScriptExecutor)d).ExecuteScript("return document.readyState").Equals("complete"));
            wait.Until(driver => By.CssSelector("footer#inviteConfirm___BV_modal_footer_ > .btn.btn-secondary"));

            ADD_MEMBER_BTN_SEND_EMAIL.Click();


            IWebElement ADD_MEMBER_ADD_MEMBER_BTN = driver.FindElement(By.CssSelector("footer#memberConfirm___BV_modal_footer_ > .btn.btn-primary"));
            ADD_MEMBER_ADD_MEMBER_BTN.Click();
